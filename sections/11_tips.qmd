...
*References can be cited in the text using the **cite** command. For example, **`\cite{ref1}`** will be replaced with **[1]** in the text. The **bibliography** section at the end of the report will contain the full citation.*
